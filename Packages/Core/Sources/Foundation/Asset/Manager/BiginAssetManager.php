...
namespace Packages\Core\Sources\Foundation\Asset\Manager;

use Illuminate\Support\Collection;
use Packages\Core\Sources\Foundation\Asset\AssetNotFoundException;

final class BiginAssetManager implements AssetManager
{
    /**
     * @var array
     */
